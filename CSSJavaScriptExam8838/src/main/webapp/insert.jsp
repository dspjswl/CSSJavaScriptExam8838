...
<div class="row" style="margin: -15px 0px;">
    ...
    <div class="col-md-10">
        ...
        <div style="margin-left: 40px;margin-top: 10px;width: 400px;">
            <form action="com.hand.servlet.HandleInsert" class="form-group">
                <div class="col-md-4">
                    First Name <h7 style="color: red">*</h7>
                </div>
                <div class="col-md-8">
                ...
                <div class="col-md-4">
                    Last Name <h7 style="color: red">*</h7>
                </div>
                <div class="col-md-8">
